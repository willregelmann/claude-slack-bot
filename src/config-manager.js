...
class ConfigManager {
  ...
  loadFromEnv() {
    ...
    if (process.env.SLACK_BOT_TOKEN) {
      envConfig.SLACK_BOT_TOKEN = process.env.SLACK_BOT_TOKEN;
    }
    if (process.env.SLACK_SIGNING_SECRET) {
      envConfig.SLACK_SIGNING_SECRET = process.env.SLACK_SIGNING_SECRET;
    }
    if (process.env.SLACK_APP_TOKEN) {
      envConfig.SLACK_APP_TOKEN = process.env.SLACK_APP_TOKEN;
    }
    if (process.env.PORT) {
